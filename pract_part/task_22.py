...
def create_custom_projects():
    ...
    project1 = Project("Проект 1")
    project1.Q_t = 196311.88         # Годовой объем товарной продукции (тыс.руб)
    project1.S_om = 4700.35           # Расходы основных материалов (тыс.руб)
    project1.S_pok = 81990.87         # Расходы покупных полуфабрикатов (тыс.руб)
    ...
    project1.S = 326631.19            # Производственная себестоимость одного изделия (руб)
    project1.S_m = 181742.59          # Начальные материальные расходы (руб)
    ...
    project1.S_r = 155803.08          # Производственная себестоимость годового выпуска (тыс.руб)

    # Проект 2 - ВАШИ ДАННЫЕ
    project2 = Project("Проект 2")
    project2.Q_t = 62795.96          # Годовой объем товарной продукции (тыс.руб)
    project2.S_om = 2162.06           # Расходы основных материалов (тыс.руб)
    project2.S_pok = 38713.57         # Расходы покупных полуфабрикатов (тыс.руб)
    ...
    project2.S = 114570.26            # Производственная себестоимость одного изделия (руб)
    project2.S_m = 93966.96          # Начальные материальные расходы (руб)
    ...
    project2.S_r = 49838.06          # Производственная себестоимость годового выпуска (тыс.руб)
