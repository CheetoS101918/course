...
def create_test_projects():
    ...
    project1.Q_t = 188244.19       # Годовой объем товарной продукции
    project1.S_om = 5057.15           # Расходы основных материалов
    project1.S_pok = 84899.20         # Расходы покупных полуфабрикатов
    project1.S_vm = 1500.0            # Годовые расходы вспомогательных материалов
    project1.N_om = 20                # Норма запаса основных материалов
    project1.N_pok = 5               # Норма запаса покупных полуфабрикатов
    project1.N_vm = 9                 # Норма запаса вспомогательных материалов
    project1.OS_prz = 500          # Норматив по прочим производственным запасам
    project1.S = 328868.25            # Производственная себестоимость одного изделия
    project1.S_m = 188587.74          # Начальные материальные расходы
    project1.T_c = 5                  # Длительность производственного цикла
    project1.N_gp = 1                 # Норма запаса готовой продукции
    project1.OS_rbp = 450           # Норматив на расходы будущих периодов
    # Дополнительные данные из расчетов
    project1.S_r = 149400.15          # Производственная себестоимость годового выпуска

    # Проект 2
    project2 = Project("Проект 2")
    # Данные из Таблицы 2.5, столбец "2"
    project2.Q_t = 166955.47          # Годовой объем товарной продукции
    project2.S_om = 4521.38           # Расходы основных материалов
    project2.S_pok = 76919.29         # Расходы покупных полуфабрикатов
    project2.S_vm = 1200.0             # Годовые расходы вспомогательных материалов
    project2.N_om = 15                # Норма запаса основных материалов
    project2.N_pok = 4               # Норма запаса покупных полуфабрикатов
    project2.N_vm = 9                 # Норма запаса вспомогательных материалов
    project2.OS_prz = 400.0           # Норматив по прочим производственным запасам
    project2.S = 319838.07            # Производственная себестоимость одного изделия
    project2.S_m = 187219.93          # Начальные материальные расходы
    project2.T_c = 4                  # Длительность производственного цикла
    project2.N_gp = 1                 # Норма запаса готовой продукции
    project2.OS_rbp = 390.0           # Норматив на расходы будущих периодов
    # Дополнительные данные из расчетов
    project2.S_r = 132504.35          # Производственная себестоимость годового выпуска
...
def create_custom_projects():
    ...
    project1 = Project("Проект 1")
    project1.Q_t = 150024.50         # Годовой объем товарной продукции (тыс.руб)
    project1.S_om = 4215.9          # Расходы основных материалов (тыс.руб)
    project1.S_pok = 55094.63         # Расходы покупных полуфабрикатов (тыс.руб)
    ...
    project1.S = 334423.61            # Производственная себестоимость одного изделия (руб)
    project1.S_m = 11809.23 + 154326.69 # Начальные материальные расходы (руб)
    ...
    project1.S_r = 119389.23         # Производственная себестоимость годового выпуска (тыс.руб)

    # Проект 2 - ВАШИ ДАННЫЕ
    project2 = Project("Проект 2")
    project2.Q_t = 162344.09          # Годовой объем товарной продукции (тыс.руб)
    project2.S_om = 4507.4           # Расходы основных материалов (тыс.руб)
    project2.S_pok = 59629.83         # Расходы покупных полуфабрикатов (тыс.руб)
    ...
    project2.S = 341780.79           # Производственная себестоимость одного изделия (руб)
    project2.S_m = 11924.34 + 157750.87 # Начальные материальные расходы (руб)
    ...
    project2.S_r = 129193.14          # Производственная себестоимость годового выпуска (тыс.руб)
