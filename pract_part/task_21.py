...
class CostCalculator:
    ...
    def load_student_example_data(self):
        ...
        self.Ka = 1.08  # коэффициент для объема производства
        ...
        self.projects_data = {
            "project_1": {
                ...
                "annual_volume_corrected": math.ceil(330  * self.Ka),
            ...
            "project_2": {
                ...
                "annual_volume_corrected": math.ceil(350  * self.Ka),
        ...
        self.cost_calculation_data = {
            "project_1": {
                ...
                "steel_rolling_consumption": 0.576,  # т - расходы стального проката (пункт 1.1)
                "steel_rolling_waste": 0.103,  # т - отходы стального проката (пункт 1.1)
                "steel_pipes_consumption": 0.0528,  # т - расходы стальных труб (пункт 1.2)
                "steel_pipes_waste": 0.0037,  # т - отходы стальных труб (пункт 1.2)
                ...
                "castings_black_waste": 0.397,  # т - отходы отливок черных металлов (пункт 2.1)
                "castings_color_consumption": 0.272,  # т - расходы отливок цветных металлов (пункт 2.2)
                "castings_color_waste": 0.0626,  # т - отходы отливок цветных металлов (пункт 2.2)
                ...
                "labor_intensity": 885.1,  # н-час - суммарная трудоемкость изделия (пункт 9)
            ...
            "project_2": {
                ...
                "steel_rolling_consumption": 0.582,  # т - скорректированный расход стального проката
                "steel_rolling_waste": 0.1049,  # т - скорректированные отходы стального проката
                "steel_pipes_consumption": 0.0516,  # т - скорректированный расход стальных труб
                "steel_pipes_waste": 0.00361,  # т - скорректированные отходы стальных труб
                ...
                "castings_black_waste": 0.407,  # т - скорректированные отходы отливок черных металлов
                "castings_color_consumption": 0.278,  # т - скорректированные расходы отливок цветных металлов
                "castings_color_waste": 0.064,  # т - скорректированные отходы отливок цветных металлов
                ...
                "labor_intensity": 905.2,  # н-час - скорректированная трудоемкость
                "hourly_rate": 41.5,  # руб - часовая тарифная ставка (та же)
