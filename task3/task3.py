...
my_variant = 8  # В вашем примере цифры соответствовали Варианту 2
...
if isinstance(data, dict):
    ...
    # Проверка вывода (как в вашем примере)
    print("# Изделие А")
    print(f"C_vm_A = {C_vm_A}")
    print(f"N_om_A = {N_om_A}")


    print("\n# Изделие Б")
    print(f"C_vm_B = {C_vm_B}")
    print(f"N_om_B = {N_om_B}")
else:
    print(data)
